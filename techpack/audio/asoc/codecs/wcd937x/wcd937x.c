...
/* Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.MACHINE, 2019/07/05, Add for custom audio */
...
#ifdef OPLUS_ARCH_EXTENDS
#ifdef DBMDX_SOUND_TRIGGER_SUPPORT
/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.CODEC.2035733, 2019/05/24,
 * add for dbmdx */
...
#ifdef OPLUS_ARCH_EXTENDS
#ifdef DBMDX_SOUND_TRIGGER_SUPPORT
		/* Yongzhi.Zhang@MULTIMEDIA.AUDIODRIVER.CODEC, 2019/10/10,
		 * add for dmic micbias reopen when enabling */
...
#ifdef OPLUS_ARCH_EXTENDS
//Le.Li@MULTIMEDIA.AUDIODRIVER.FTM.954616, 2018/03/15, Add for FTM micbias test
...
static const struct snd_kcontrol_new wcd937x_snd_controls[] = {
	#ifdef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.FTM.954616, 2016/08/24,
